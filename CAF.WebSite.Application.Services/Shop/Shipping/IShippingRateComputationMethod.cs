...
using CAF.WebSite.Application.Services.Shipping.Tracking;
...
namespace CAF.WebSite.Application.Services.Shipping
{
    ...
    public partial interface IShippingRateComputationMethod : IProvider, IUserEditable
    {
		...
		/// <summary>
		/// Gets a value indicating whether the shipping rate computation method is active and should be offered to users
		/// </summary>
		bool IsActive { get; }
    }
}
