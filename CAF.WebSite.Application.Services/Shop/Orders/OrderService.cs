...
namespace CAF.WebSite.Application.Services.Orders
{
    ...
    public partial class OrderService : IOrderService
    {
        ...
        /// Search orders
        /// </summary>
		/// <param name="siteId">Store identifier; 0 to load all orders</param>
		...
		public virtual IPagedList<Order> SearchOrders(int siteId, int userId, DateTime? startTime, DateTime? endTime, 
        ...
        /// </summary>
		/// <param name="siteId">The store identifier; 0 to load all records</param>
		...
		public virtual IList<RecurringPayment> SearchRecurringPayments(int siteId, 
			int userId, int initialOrderId, OrderStatus? initialOrderStatus,
			bool showHidden = false)
        {
            ...
            var query1 = from rp in _recurringPaymentRepository.Table
						 ...
						 (siteId == 0 || rp.InitialOrder.SiteId == siteId) &&
        ...
        /// </summary>
		/// <param name="siteId">Store identifier; 0 to load all entries</param>
        /// <param name="userId">User identifier; null to load all entries</param>
		...
		public virtual IPagedList<ReturnRequest> SearchReturnRequests(int siteId, int userId, int orderItemId, ReturnRequestStatus? rs, int pageIndex, int pageSize, int id = 0)
        {
            var query = _returnRequestRepository.Table;

			if (siteId > 0)
				query = query.Where(rr => siteId == rr.SiteId);
