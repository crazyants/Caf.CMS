...
namespace CAF.WebSite.Application.Services.Orders
{
    ...
    public partial interface IOrderService
    {
        ...
        /// Search orders
        /// </summary>
		/// <param name="siteId">Store identifier; null to load all orders</param>
		...
		IPagedList<Order> SearchOrders(int siteId, int userId, DateTime? startTime, DateTime? endTime,
		...
		IList<RecurringPayment> SearchRecurringPayments(int siteId, 
			int userId, int initialOrderId, OrderStatus? initialOrderStatus, bool showHidden = false);
		...
		IPagedList<ReturnRequest> SearchReturnRequests(int siteId, int userId, int orderItemId, ReturnRequestStatus? rs, int pageIndex, int pageSize, int id = 0);
