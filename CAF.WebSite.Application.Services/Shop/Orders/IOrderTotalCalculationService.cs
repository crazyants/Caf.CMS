...
namespace CAF.WebSite.Application.Services.Orders
{
    ...
    public partial interface IOrderTotalCalculationService
    {
        ...
        decimal GetOrderSubtotalDiscount(User user,
        ...
        decimal GetShippingDiscount(User user, decimal shippingTotal, out Discount appliedDiscount);
        ...
        /// <param name="appliedDiscount">Applied discount</param>
        /// <returns>Order discount</returns>
        decimal GetOrderTotalDiscount(User user, decimal orderTotal, out Discount appliedDiscount);
