...
namespace CAF.WebSite.Application.Services.Catalog
{
    ...
    {
        #region Constants
        private const string PRODUCTATTRIBUTES_ALL_KEY = "WebSite.productattribute.all";
        private const string PRODUCTVARIANTATTRIBUTES_ALL_KEY = "WebSite.productvariantattribute.all-{0}";
        private const string PRODUCTVARIANTATTRIBUTEVALUES_ALL_KEY = "WebSite.productvariantattributevalue.all-{0}";
        private const string PRODUCTATTRIBUTES_PATTERN_KEY = "WebSite.productattribute.";
        private const string PRODUCTVARIANTATTRIBUTES_PATTERN_KEY = "WebSite.productvariantattribute.";
        private const string PRODUCTVARIANTATTRIBUTEVALUES_PATTERN_KEY = "WebSite.productvariantattributevalue.";
        private const string PRODUCTATTRIBUTES_BY_ID_KEY = "WebSite.productattribute.id-{0}";
        private const string PRODUCTVARIANTATTRIBUTES_BY_ID_KEY = "WebSite.productvariantattribute.id-{0}";
        private const string PRODUCTVARIANTATTRIBUTEVALUES_BY_ID_KEY = "WebSite.productvariantattributevalue.id-{0}";
