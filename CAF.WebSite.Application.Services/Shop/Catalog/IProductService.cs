...
namespace CAF.WebSite.Application.Services.Catalog
{
    ...
    public partial interface IProductService
    {
		...
		/// <param name="allowedUserRolesIds">User role ids (ACL).</param>
		/// <param name="searchLocalizedValue">Whether to search localized values.</param>
		IQueryable<Product> PrepareProductSearchQuery(ProductSearchContext ctx, IEnumerable<int> allowedUserRolesIds = null, bool searchLocalizedValue = false);
		...
		/// <param name="allowedUserRolesIds">User role ids (ACL).</param>
		/// <param name="searchLocalizedValue">Whether to search localized values.</param>
		IQueryable<TResult> PrepareProductSearchQuery<TResult>(ProductSearchContext ctx, Expression<Func<Product, TResult>> selector, IEnumerable<int> allowedUserRolesIds = null, bool searchLocalizedValue = false);
