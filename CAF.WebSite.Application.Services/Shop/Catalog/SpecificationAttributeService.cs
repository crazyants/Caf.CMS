...
namespace CAF.WebSite.Application.Services.Catalog
{
    ...
    {
        #region Constants
        private const string PRODUCTSPECIFICATIONATTRIBUTE_ALLBYPRODUCTID_KEY = "WebSite.productspecificationattribute.allbyproductid-{0}-{1}-{2}";
        private const string PRODUCTSPECIFICATIONATTRIBUTE_PATTERN_KEY = "WebSite.productspecificationattribute.";
        #endregion
