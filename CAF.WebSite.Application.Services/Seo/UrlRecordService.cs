...
namespace CAF.WebSite.Application.Services.Seo
{
    ...
    public partial class UrlRecordService : IUrlRecordService
    {
        ...
        private const string URLRECORD_ACTIVE_BY_ID_NAME_LANGUAGE_KEY = "Caf.urlrecord.active.id-name-language-{0}-{1}-{2}";
        private const string URLRECORD_PATTERN_KEY = "Caf.urlrecord.";
