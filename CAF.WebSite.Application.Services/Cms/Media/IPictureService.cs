...
namespace CAF.WebSite.Application.Services.Media
{
    ...
    public partial interface IPictureService
    {
        ...
        /// <param name="storeLocation">Site location URL; null to use determine the current store location automatically</param>
        ...
        void AddImageToWatermark(string LocalPath);
