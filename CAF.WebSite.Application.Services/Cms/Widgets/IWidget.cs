...
namespace CAF.WebSite.Application.Services.Cms
{
    ...
    public partial interface IWidget : IProvider, IUserEditable
    {
		...
		/// <param name="siteId">The id of the current store</param>
        /// <param name="actionName">Action name</param>
        /// <param name="controllerName">Controller name</param>
        /// <param name="routeValues">Route values</param>
        void GetDisplayWidgetRoute(string widgetZone, object model, int siteId, out string actionName, out string controllerName, out RouteValueDictionary routeValues);
    }
}
