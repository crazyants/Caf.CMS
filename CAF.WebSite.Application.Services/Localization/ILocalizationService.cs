...
namespace CAF.WebSite.Application.Services.Localization
{
    ...
    public partial interface ILocalizationService
    {
        ...
        IList<LocaleStringResource> GetAllResources(int languageId, string resourceName = null);
        ...
        /// <param name="languageId">Language identifier</param>
        /// <returns>Locale string resources</returns>
        IDictionary<string, Tuple<int, string>> GetResourceValues(int languageId, string rName = null, bool forceAll = false);
