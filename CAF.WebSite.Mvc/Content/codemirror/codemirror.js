...
(function(mod) {
  ...
  function DisplayUpdate(cm, viewport, force) {
    ...
    // Site some values that we'll need later (but don't want to force a relayout for)
  ...
  // Site a relative adjustment to the scroll position in the current
  ...
  function buildLineContent(cm, lineView) {
    ...
    for (var i = 0; i <= (lineView.rest ? lineView.rest.length : 0); i++) {
      ...
      // Site the map and a cache object for the current logical line
      if (i == 0) {
