...
namespace CAF.WebSite.Mvc.Content.filemanager.asp_net
{
    /// <summary>
    /// Handler1 的摘要说明
    /// </summary>
    ...
    {
        CAF.WebSite.Application.Services.Media.IPictureService _pictureService;
        public RoxyFilemanHandler(CAF.WebSite.Application.Services.Media.IPictureService pictureService)
        {
            ...
            try
            {
                for (int i = 0; i < HttpContext.Current.Request.Files.Count; i++)
                {
                    if (CanHandleFile(HttpContext.Current.Request.Files[i].FileName))
                    {
                        ...
                        //水印
                        this._pictureService.AddImageToWatermark(dest);
