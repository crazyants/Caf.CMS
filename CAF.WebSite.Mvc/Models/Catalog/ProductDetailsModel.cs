...
namespace CAF.WebSite.Mvc.Models.Catalog
{
    public partial class ProductDetailsModel : EntityModelBase
    {
		...
		public partial class AddToCartModel : ModelBase
		{
			...
			[LangResourceDisplayName("Products.Qty")]
			public int EnteredQuantity { get; set; }

			[LangResourceDisplayName("Products.EnterProductPrice")]
		...
		public partial class GiftCardModel : ModelBase
		{
			...
			[LangResourceDisplayName("Products.GiftCard.RecipientName")]
			[AllowHtml]
			public string RecipientName { get; set; }
			[LangResourceDisplayName("Products.GiftCard.RecipientEmail")]
			[AllowHtml]
			public string RecipientEmail { get; set; }
			[LangResourceDisplayName("Products.GiftCard.SenderName")]
			[AllowHtml]
			public string SenderName { get; set; }
			[LangResourceDisplayName("Products.GiftCard.SenderEmail")]
			[AllowHtml]
			public string SenderEmail { get; set; }
			[LangResourceDisplayName("Products.GiftCard.Message")]
			[AllowHtml]
