...
namespace CAF.Infrastructure.Data.Setup
{
	...
	/// </summary>
	public class InstallDatabaseInitializer : MigrateDatabaseInitializer<DefaultObjectContext, MigrationsConfiguration>
	{
		#region Ctor
		...
		/// <inheritdoc />
		public override void InitializeDatabase(DefaultObjectContext context)
		{
