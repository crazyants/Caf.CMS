using CAF.Infrastructure.Core.Html.CodeFormatter;
using System;
using System.Text.RegularExpressions;
 

namespace CAF.Infrastructure.Core.Html
{
    /// <summary>
    /// Represents a BBCodve helper
    /// </summary>
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote)
        {
            ...
            if (replaceUrl)
            {
                // format the url tags: [url=http://www.CAF.com]my site[/url]
                // becomes: <a href="http://www.CAF.com">my site</a>
                text = regexUrl1.Replace(text, "<a href=\"$1\" rel=\"nofollow\">$2</a>");

                // format the url tags: [url]http://www.CAF.com[/url]
                // becomes: <a href="http://www.CAF.com">http://www.CAF.com</a>
