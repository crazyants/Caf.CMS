...
namespace CAF.Infrastructure.Core.Domain.Cms.Products
{
    /// <summary>
    /// Represents a product
    /// </summary>
    [DataContract]
    public partial class Product : BaseEntity, ISoftDeletable, ILocalizedEntity, ISlugSupported, IAclSupported, ISiteMappingSupported, IMergedData
    {
