...
{
    /// <summary>
    /// A class that finds types needed by CrAnt.FrameWork. by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether CAF should iterate assemblies in the app domain when loading CAF types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that CAF assemblies arn't investigated (e.g. by not including something like "^CAF|..." you may break core functionality.</remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the CAF factory.</returns>
        ...
        /// <returns>True if the assembly should be loaded into CAF.</returns>
