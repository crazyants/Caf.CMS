...
namespace MVCGrid.Models
{
    public class MVCGridBuilder<T1>
    {
        ...
        /// <summary>
        /// the grid Key Field Name
        /// </summary>
        public MVCGridBuilder<T1> WithKeyId(string keyId)
        {
            GridDefinition.KeyId = keyId;
            return this;
        }

        /// <summary>
        /// Enables the grid  CheckBox
        /// </summary>
        public MVCGridBuilder<T1> WithShowCheckBox(bool checkBox=false)
        {
            GridDefinition.ShowCheckBox = checkBox;
            return this;
        }
