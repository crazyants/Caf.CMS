...
{
	public class CAFUrlRoutingModule : IHttpModule
	{
		...
		/// <remarks>
		/// For performance reasons SmartSite.NET is configured to serve static files (files with extensions other than those mapped to managed handlers)
