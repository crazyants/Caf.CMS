...
namespace CAF.WebSite.Application.WebUI.Themes
{

    public class WorkStyleBundle : Bundle
    {
        private bool _wasCached = false;
        private bool _isClearTransform = false;
        private string[] _originalBundleFilePathes;
        private IEnumerable<BundleFile> _transformedBundleFiles;

        public WorkStyleBundle(string virtualPath)
            : this(virtualPath, null)
        { }

        public WorkStyleBundle(string virtualPath, string cdnPath)
