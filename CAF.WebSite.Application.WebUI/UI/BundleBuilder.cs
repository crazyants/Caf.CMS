...
namespace CAF.WebSite.Application.WebUI.UI
{
    ...
    {
        // private readonly IApplicationContext _storeContext;
        private readonly IWorkContext _workContext;
        private static readonly object s_lock = new object();

        public BundleBuilder(IWorkContext workContext)
        {
                ...
                lock (s_lock)
                {
                    ...
                    if (bundleFor == null)
                    {
                        ...
                        Bundle bundle = (type == BundleType.Script) ?
                            ...
                            new WorkStyleBundle(bundleVirtualPath) as Bundle;
        ...
        protected virtual string GetBundleVirtualPath(BundleType type, IEnumerable<string> files)
        {
            ...
            using (SHA256 sha = new SHA256Managed())
            {
                ...
                {
                    // hash += "-s" + _storeContext.CurrentSite.Id;
                    hash += "-s" + 1;
                }
            }
