...
namespace CAF.WebSite.Application.WebUI.Plugins
{
	public class PluginMediator
	{
		...
		public string GetDefaultIconUrl(string groupName)
		{
			...
			{
				string path = "~/Administrator/Content/images/icon-plugin-{0}.png".FormatInvariant(groupName.ToLower());
			...
			return "~/Administrator/Content/images/icon-plugin-default.png";
		}
